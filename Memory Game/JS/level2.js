document.addEventListener('DOMContentLoaded', () => {
    ...
    const cardArray = [
        ...
        {name: 'bale',
         img: './img/soccer/bale.jpg'},
    
        {name: 'bale',
         img: './img/soccer/bale.jpg'},
    
        {name: 'benzema',
         img: './img/soccer/benzema.jpg'},
    
        {name: 'benzema',
         img: './img/soccer/benzema.jpg'},

        {name: 'ibrahimovic',
         img: './img/soccer/ibrahimovic.jpg'},
    
        {name: 'ibrahimovic',
         img: './img/soccer/ibrahimovic.jpg'},

         {name: 'kevin',
         img: './img/soccer/kevin.jpg'},
    
        {name: 'kevin',
         img: './img/soccer/kevin.jpg'},

         {name: 'mbappe',
         img: './img/soccer/mbappe.jpg'},
    
        {name: 'mbappe',
         img: './img/soccer/mbappe.jpg'},

         {name: 'messi',
         img: './img/soccer/messi.jpg'},
    
        {name: 'messi',
         img: './img/soccer/messi.jpg'},

         {name: 'Neymar',
         img: './img/soccer/Neymar.jpg'},
    
        {name: 'Neymar',
         img: './img/soccer/Neymar.jpg'},

         {name: 'pogba',
         img: './img/soccer/pogba.jpg'},
    
        {name: 'pogba',
         img: './img/soccer/pogba.jpg'},

         {name: 'ramos',
         img: './img/soccer/ramos.jpg'},
    
        {name: 'ramos',
         img: './img/soccer/ramos.jpg'},

         {name: 'ronaldo',
         img: './img/soccer/ronaldo.jpg'},
