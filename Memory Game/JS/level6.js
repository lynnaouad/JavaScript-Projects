document.addEventListener('DOMContentLoaded', () => {
    ...
    const cardArray = [
        ...
        {name: 'logo1',
         img: './img/planet/planet-weight-calc (1).jpg'},
    
        {name: 'logo1',
         img: './img/planet/planet-weight-calc (1).jpg'},

         {name: 'logo2',
         img: './img/planet/planet-weight-calc (2).jpg'},
    
        {name: 'logo2',
         img: './img/planet/planet-weight-calc (2).jpg'},

         {name: 'logo3',
         img: './img/planet/planet-weight-calc (3).jpg'},
    
        {name: 'logo3',
         img: './img/planet/planet-weight-calc (3).jpg'},

         {name: 'logo4',
         img: './img/planet/planet-weight-calc (4).jpg'},
    
        {name: 'logo4',
         img: './img/planet/planet-weight-calc (4).jpg'},

         {name: 'logo5',
         img: './img/planet/planet-weight-calc (5).jpg'},
    
        {name: 'logo5',
         img: './img/planet/planet-weight-calc (5).jpg'},

         {name: 'logo6',
         img: './img/planet/planet-weight-calc (6).jpg'},
    
        {name: 'logo6',
         img: './img/planet/planet-weight-calc (6).jpg'},

         {name: 'logo7',
         img: './img/planet/planet-weight-calc (7).jpg'},
    
        {name: 'logo7',
         img: './img/planet/planet-weight-calc (7).jpg'},

         {name: 'logo8',
         img: './img/planet/planet-weight-calc (8).jpg'},
    
        {name: 'logo8',
         img: './img/planet/planet-weight-calc (8).jpg'},

         {name: 'logo9',
         img: './img/planet/planet-weight-calc (9).jpg'},
    
        {name: 'logo9',
         img: './img/planet/planet-weight-calc (9).jpg'},

         {name: 'logo10',
         img: './img/planet/planet-weight-calc (10).jpg'},
    
        {name: 'logo10',
         img: './img/planet/planet-weight-calc (10).jpg'},

         {name: 'logo11',
         img: './img/planet/planet-weight-calc (11).jpg'},
    
        {name: 'logo11',
         img: './img/planet/planet-weight-calc (11).jpg'},

         {name: 'logo12',
         img: './img/planet/planet-weight-calc (12).jpg'},
    
        {name: 'logo12',
         img: './img/planet/planet-weight-calc (12).jpg'},

         {name: 'logo13',
         img: './img/planet/planet-weight-calc (13).jpg'},
    
        {name: 'logo13',
         img: './img/planet/planet-weight-calc (13).jpg'},

         {name: 'logo14',
         img: './img/planet/planet-weight-calc (14).jpg'},
    
        {name: 'logo14',
         img: './img/planet/planet-weight-calc (14).jpg'},

         {name: 'logo15',
         img: './img/planet/planet-weight-calc (15).jpg'},
